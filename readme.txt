...
There are no settings or custom functions. Set custom post types to be sticky just as you would with regular posts, and use the appropriate built-in functions and queries.